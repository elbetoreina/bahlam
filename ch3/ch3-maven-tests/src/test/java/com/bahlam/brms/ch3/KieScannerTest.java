...
import com.bahlam.brms.training.util.FileManager;
...
public class KieScannerTest {
    ...
    private InternalKieModule createKieJar(KieServices ks, ReleaseId releaseId, String... rules) throws IOException {
        ...
        packageBuilder.append("import com.bahlam.brms.training.model.Customer;\n");
        packageBuilder.append("import com.bahlam.brms.training.model.Order;\n");
        packageBuilder.append("import com.bahlam.brms.training.model.Discount;\n");
